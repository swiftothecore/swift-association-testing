...
export const CHALLENGES = [
  ...
  { id: "shrinking-timer", name: "Shrinking Timer", rule: "accelerate", mode: "medium",
    free: false, cost: 1, target: 9, noTitle: false, pool: "easy", icon: "hourglass",
    blurb: "suggestions · the clock shrinks every page (16s → 5s)",
  ...
  { id: "title-in", name: "Title...?", rule: "titleHas", mode: "medium",
    free: false, cost: 1, target: 9, noTitle: false, dropdown: false, icon: "key",
  ...
  { id: "short-title", name: "Short n' Sweet", rule: "shorttitle", mode: "medium",
    free: false, cost: 1, target: 9, pool: "easy", noTitle: false, icon: "feather",
  ...
  { id: "lyric-lover", name: "Lyric Lover", rule: "verse", mode: "lyricist",
    free: false, cost: 1, target: 6, icon: "quote",
  ...
  { id: "wrapped-chain", name: "Wrapped Like A Chain", rule: "chain", mode: "medium",
    free: false, cost: 1, target: 6, noTitle: false, pool: "easy", icon: "scarf",
