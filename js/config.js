...
export const CHALLENGES = [
  ...
  { id: "one-of-a-kind", name: "One Of A Kind", rule: "newsong", mode: "easy",
    ...
    desc: "You're given one specific song. Slip it in as your answer for at least one word — trying it on a word that doesn't fit costs you nothing.",
    win: "Answer the named song on any round where it fits." },
