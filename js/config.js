...
export const CHALLENGES = [
  ...
  { id: "shrinking-timer", name: "Shrinking Timer", rule: "accelerate", mode: "medium",
    free: false, cost: 1, target: 9, dropdown: false, noTitle: false, pool: "easy", icon: "hourglass",
    blurb: "no suggestions · the clock shrinks every page (16s → 5s)",
  ...
  { id: "title-in", name: "Title...?", rule: "titleHas", mode: "medium",
    free: false, cost: 1, target: 9, noTitle: false, icon: "key",
    blurb: "10s · suggestions · the word must be in the title",
